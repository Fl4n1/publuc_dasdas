<x-admin-layout>
  <div class="py-12 w-full">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="flex p-2">
        <a href="{{ route('admin.permissions.index') }}" class="px-4 duration-75 py-2 text-white hover:text-black bg-green-700 
        hover:bg-green-500 rounded-md">Страница права</a>
      </div>
