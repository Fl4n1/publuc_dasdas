<x-admin-layout>
    <div class="flex justify-end p-2 mb-2">
        <a href="{{ route('admin.posts.create') }}" class="px-4 py-2 bg-green-700 text-white hover:text-black hover:bg-green-500
         rounded-md duration-75"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <td>
                                    <div class="flex justify-end">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('admin.posts.edit', $post) }}" class="px-4 py-2 bg-blue-500 hover:bg-blue-700 text-white rounded-md"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
